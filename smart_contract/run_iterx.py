...
Task: Smart Contract Gas Optimization
"""
...
def create_task():
    ...
    response = requests.post(
        ...
        headers=headers,
        json={
            "task_name": "Smart Contract Gas Optimization",
            "task_description": """**Goal:** Design a gas-minimizing batch transfer function for ERC-20 tokens.
...
def step_3_get_reward(code):
    # Use the get_reward function from eval_smart_contract_gas.py
    try:
        work_dir = "/data/iterx/smart_contract"
