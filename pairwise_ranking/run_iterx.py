...
from eval_pairwise_ranking import get_reward
...
def create_task():
    ...
    response = requests.post(
        ...
        headers=headers,
        json={
            "task_name": "Design a Pair Scoring Function",
            "task_description": """**Goal:** Design a scoring function for pairs of integers.
...
**Things to Avoid:** None""",
            "reward_description": "Fraction of concordant pairs: reward = concordant_pairs / total_pairs. Range [0.0, 1.0], higher is better. Perfect score (1.0) means all pairwise orderings are correct.",
...
def step_3_get_reward(code):
    # Use the get_reward function from eval_pairwise_ranking.py
    try:
