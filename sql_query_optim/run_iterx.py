...
def create_task():
    ...
    response = requests.post(
        ...
        headers=headers,
        json={
            "task_name": "SQL Query Optimization",
            "task_description": """**Goal:** Generate a Python function `transform_query(sql: str) -> str` that transforms SQL queries into optimized versions.
...
def step_3_get_reward(code):
    # Use the get_reward function from eval_sql_optim.py
    try:
