...
from eval_online_packing import get_reward
...
def create_task():
    ...
    response = requests.post(
        ...
        headers=headers,
        json={
            "task_name": "Online Bin Packing",
            "task_description": """**Goal:** Design a scoring function for online bin packing that minimizes the number of bins used.
...
def step_3_get_reward(code):
    # Use the get_reward function from eval_online_packing.py
    try:
